package ru.rdtex.mvd.weapon.global;
...
public class JSFUtils
{
  ...
  public static Object resolveMethodExpression(
    String expression, Class returnType, Class[] argTypes,
                                         Object[] argValues)
  {
    FacesContext facesContext = getFacesContext();
    Application app = facesContext.getApplication();
  ...
  /**
   * Convenience method for resolving a reference to a managed bean by description
   * rather than by expression.
   * @param beanName description of managed bean
   * @return Managed object
   */
   ...
   * @param expression EL expression
   * @param newValue new defaultValue to set
   * Работает
   */
  ...
  /**
   * Convenience method for setting the defaultValue of a managed bean by description
   * rather than by expression.
   * @param beanName description of managed bean
   * @param newValue new defaultValue to set
   */
   ...
   * @param object defaultValue to store
   */
   ...
   * @return Resource defaultValue or placeholder error String
   */
   ...
   * @param attrName description of attribute
   * @param msg error message string
   */
   ...
   * @param name attribute description
   * @param value attribute defaultValue
   */
  ...
  public static void redirect(String shortUrl)
    throws IOException
  {
  ...
  {
    Object obj = resolveExpression(exp);
